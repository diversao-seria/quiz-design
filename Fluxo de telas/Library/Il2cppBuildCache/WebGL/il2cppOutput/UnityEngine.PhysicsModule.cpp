...
{
	typedef float (*CharacterController_get_slopeLimit_mED9B8D902FB896E497D0A83F4FB9C9C133280ACB_ftn) (CharacterController_tCCF68621C784CCB3391E0C66FE134F6F93DD6C2E *);
	static CharacterController_get_slopeLimit_mED9B8D902FB896E497D0A83F4FB9C9C133280ACB_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (CharacterController_get_slopeLimit_mED9B8D902FB896E497D0A83F4FB9C9C133280ACB_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.CharacterController::get_slopeLimit()");
	float icallRetVal = _il2cpp_icall_func(__this);
	return icallRetVal;
}
// UnityEngine.CollisionFlags UnityEngine.CharacterController::Move_Injected(UnityEngine.Vector3&)
